"""
Generate rq6_tone_*.csv files from parquets with VADER sentiment analysis.
...
OUTPUT_TABLES = ROOT / "outputs" / "rq6" / "tables"
...
def run():
    ...
    for name in datasets:
        ...
        # Save to CSV
        output_file = OUTPUT_TABLES / f"rq6_tone_{name}.csv"
