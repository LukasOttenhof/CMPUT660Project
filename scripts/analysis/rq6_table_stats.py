...
TABLE_OUT_DIR = ROOT / "outputs" / "rq6" / "latex_tables"
TONE_TABLES = ROOT / "outputs" / "rq6" / "tables"
PLOT_DIR = ROOT / "outputs" / "rq6" / "plots"
...
TONE_FILES = {
    "Commit Messages": "rq6_tone_commit_messages.csv",
    "Issues": "rq6_tone_issue_bodies.csv",
    "Pull Request Bodies": "rq6_tone_pr_bodies.csv",
    "Review Comments": "rq6_tone_review_comments.csv",
}
