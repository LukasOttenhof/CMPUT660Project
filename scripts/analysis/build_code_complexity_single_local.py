...
# ✅ CHANGE 1: different output parquet name
OUT_PARQUET = os.path.join(OUTPUT_DIR, "single_repo_month_complexity.parquet")
...
def main() -> None:
    ...
    # ✅ CHANGE 2: only first repo
    if not specs:
        print("No repos found in repo list.")
        return
    specs = [specs[0]]
